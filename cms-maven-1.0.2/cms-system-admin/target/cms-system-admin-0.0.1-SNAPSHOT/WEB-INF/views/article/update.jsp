...
<!-- 配置文件 -->
   ...
   <script type="text/javascript" charset="utf-8" src="<%=basePath%>ueditor/lang/zh-cn/zh-cn.js"></script>
    ...
    <script type="text/javascript">
       ...
       // alert("content:"+document.getElementById("content").value);
		...
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<form class="form-horizontal" id="formid" role="form"
					action="<%=basePath%>admin/article/update" method="post">
					
					 <input type="hidden" id="imgurl" name="imgurl" value="${entity.imgurl}"/>
					        <input type="hidden" class="form-control" name="aid" value="${entity.aid }" /> 
						 标题:<input type="text" class="form-control" name="title" value="${entity.title }" /> 
						 ...
						 摘要:<input type="text" class="form-control" name="summary" value="${entity.summary }" /> 
