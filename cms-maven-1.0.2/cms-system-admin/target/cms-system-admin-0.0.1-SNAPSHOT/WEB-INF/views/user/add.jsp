	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<h2 class="sub-header">添加用户信息</h2>
				<form class="form-horizontal" id="formid" role="form"
					action="<%=basePath%>admin//user/add" method="post">
					<input type="hidden" class="form-control" name="uid" readonly="readonly" value="" />
						 用户名:<input type="text" class="form-control" name="username" value="" /> 
						 密码:<input type="password" class="form-control" name="password" value="" /> 
						 电话:<input type="number" class="form-control" name="phone" value="" /> 
						  邮箱:<input type="email" class="form-control" name="email" value="" /> 
