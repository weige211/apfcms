				...
				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					...
					<div class="table-responsive">
						<table class="table table-striped">
							<a class="btn btn-success" href="<%=basePath%>admin/article/add"><span class="glyphicon glyphicon-plus"></span>添加</a>
							<thead>
								<tr>
									<th>ID</th>
									<th>文章标题</th>
							...
							<c:forEach items="${page.page}" var="item">
								<tr>
									...
									<td>
										<a class="btn btn-warning btn-sm" href="<%=basePath%>admin/article/${item.aid }/update"><span class="glyphicon glyphicon-pencil"></span>修改</a>|
										<a class="btn btn-danger btn-sm" href="<%=basePath%>admin/article/${item.aid }/del"><span class="glyphicon glyphicon-remove"></span>删除</a>
									</td>
								</tr>
								</c:forEach>
							</tbody>
					...
					<c:choose>
						<c:when test="${page.nowPage-1>0}">
							<a href="<%=basePath%>admin/article/articles/${page.nowPage-1}/page"
					...
					<c:forEach var="i" begin="1" end="${page.count}" step="1">
						<c:choose>
							<c:when test="${i==page.nowPage}">
								<a href="<%=basePath%>admin/article/articles/${i}/page"
