...
<body>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">嗨客CMS后台管理系统</a>
			</div>
			<div id="navbar" class="navbar-collapse collapse">

				<ul class="nav navbar-nav navbar navbar-right">
					<li><a
						href="<%=basePath%>user/<%=s.getAttribute("uid")%>/update"><span
							class="glyphicon glyphicon-user"></span><%=s.getAttribute("username")%></a></li>
					<li><a href="<%=basePath%>user/signout"><span
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<h2 class="sub-header">添加根节点菜单信息</h2>
				<form class="form-horizontal" id="formid" role="form"
					action="<%=basePath%>menu/add" method="post">
					<input type="hidden" class="form-control" name="parid" readonly="readonly" value="1" /> 
	...
	<script type="text/javascript">
	       function getchild(data,split){
			...
			$(function() {
				var url = "<%=basePath%>menu/menus/trees";
					...
					success: function(data) {
						if(data != null) {
							if(data.status == "ok") {
								...
								var html="";
								for(var item in data.data.nodes){
								html=html+getchild(data.data.nodes[item],"");
								}
								//alert(html);
