	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<h2 class="sub-header">修改角色信息</h2>
				<form class="form-horizontal" id="formid" role="form"
					action="<%=basePath%>admin//role/update" method="post">
					<input type="hidden" class="form-control" name="uid" readonly="readonly" value="${role.rid}" />
						 角色名:<input type="text" class="form-control" name="username" value="${role.rolename}" />  
						 备注:<input type="text" class="form-control" name="remark" value="${role.remark}" /> <br>
