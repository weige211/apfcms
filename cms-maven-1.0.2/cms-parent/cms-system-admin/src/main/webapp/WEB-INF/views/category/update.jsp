	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<h2 class="sub-header">修改类别</h2>
				<form class="form-horizontal" id="formid" role="form"
					action="<%=basePath%>admin/category/update" method="post">
					        <input type="hidden" class="form-control" name="cid" value="${entity.cid }" /> 
						 类别名称:<input type="text" class="form-control" name="catename" value="${entity.catename }" /> 					  
