	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<h2 class="sub-header">修改菜单信息</h2>
				<form class="form-horizontal" id="formid" role="form"
					action="<%=basePath%>admin//menu/update" method="post">
					选择父节点：
					...
					<select id="querynode" class="form-control" name="parid">
					 ...
					 名称:<input type="text" class="form-control" name="menuname" value="${menu.menuname}" /> 
			                      链接:<input type="text" class="form-control" name="url" value="${menu.url}" /> 
			                      备注:<input type="text" class="form-control" name="remark" value="${menu.remark}" /> <br>
