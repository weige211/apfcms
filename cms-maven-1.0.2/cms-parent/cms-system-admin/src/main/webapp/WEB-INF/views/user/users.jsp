				...
				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					...
					<div class="table-responsive">
						<table class="table table-striped">
							<a class="btn btn-success" href="<%=basePath%>admin/user/add"><span class="glyphicon glyphicon-plus"></span>添加</a>
							<thead>
								<tr>
									<th>用户名</th>
									<th>电话</th>
							...
							<c:forEach items="${list}" var="item">
								<tr>
									...
									<td>
										<a class="btn btn-warning btn-sm" href="<%=basePath%>admin/user/${item.uid }/update"><span class="glyphicon glyphicon-pencil"></span>修改</a>|
										<a class="btn btn-danger btn-sm" href="<%=basePath%>admin/user/${item.uid }/del"><span class="glyphicon glyphicon-remove"></span>删除</a>|
										<a id="reset" class="btn btn-primary" onclick="resetPwd('${item.uid}')"><span class="glyphicon glyphicon-repeat"></span>重置密码</a>
									</td>
								</tr>
								</c:forEach>
							</tbody>
