                    ...
                    <div id="page-content">
                        ...
                        <div class="block full">
                            ...
                            <div class="table-responsive">
                                ...
                                <a class="btn btn-primary" href="<%=basePath%>admin/category/add"><span class="fa fa-plus"></span>添加</a>
                                    <thead>
                                        <tr>
								...
								<tr>
									...
									<td>
									 <a href="<%=basePath%>admin/category/${item.cid }/update" data-toggle="tooltip" title="修改" class="btn btn-effect-ripple btn-xs btn-success"><i class="fa fa-pencil"></i></a>
									 <a href="<%=basePath%>admin/category/${item.cid }/del" data-toggle="tooltip" title="删除" class="btn btn-effect-ripple btn-xs btn-danger"><i class="fa fa-times"></i></a>
									</td>
								</tr>
								</c:forEach>
                                    </tbody>
