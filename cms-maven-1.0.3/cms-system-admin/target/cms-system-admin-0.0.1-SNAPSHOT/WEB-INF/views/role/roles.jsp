                    ...
                    <div id="page-content">
                        ...
                        <div class="block full">
                            ...
                            <div class="table-responsive">
                                ...
                                <a class="btn btn-primary" href="<%=basePath%>admin/role/add"><span class="fa fa-plus"></span>添加</a>
                                    <thead>
                                        <tr>
                                            <th class="text-center" style="width: 75px;">角色名称</th>
                                            <th>备注</th>
                                            <th>创建时间</th>
									        <th>创建人</th>
								...
								<tr>
									...
									<td>
									 <a href="<%=basePath%>admin/role/${item.rid }/update" data-toggle="tooltip" title="修改" class="btn btn-effect-ripple btn-xs btn-success"><i class="fa fa-pencil"></i></a>
									 <a href="<%=basePath%>admin/role/${item.rid }/del" data-toggle="tooltip" title="删除" class="btn btn-effect-ripple btn-xs btn-danger"><i class="fa fa-times"></i></a>
									</td>
								</tr>
								</c:forEach>
                                    </tbody>
