                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li class="active">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a class="active" href="<%=basePath%>admin/role/roles">角色管理</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                        ...
                        <div class="row">
                        	 <div class="col-md-12">
                        	 	<div class="block">
                                    ...
                                    <form action="<%=basePath%>admin/role/update" method="post" class="form-horizontal form-bordered">
                                        <input type="hidden" class="form-control" name="uid" readonly="readonly" value="${role.rid}" />
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-hf-email">角色名</label>
                                            <div class="col-md-9">
                                                <input type="text" id="example-hf-email" name="rolename" class="form-control" value="${role.rolename}">
                                                <span class="help-block">请输入角色名</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="email" id="example-hf-email" name="remark" value="${role.remark}" class="form-control">
