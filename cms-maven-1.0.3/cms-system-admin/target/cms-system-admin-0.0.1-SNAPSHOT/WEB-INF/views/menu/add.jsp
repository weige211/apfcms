                        	 	...
                        	 	<div class="block">
                                    ...
                                    <form action="<%=basePath%>admin/menu/add" method="post" class="form-horizontal form-bordered">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="example-hf-email" name="menuname" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="example-hf-email" name="url" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="email" id="example-hf-email" name="remark" class="form-control">
