                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li class="active">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a class="active" href="<%=basePath%>admin/menu/menus">菜单管理</a>
                                        </li>
                                        <li>
                        ...
                        <div class="row">
                        	 <div class="col-md-12">
                        	 	<div class="block">
                                    ...
                                    <form action="<%=basePath%>admin/menu/add" method="post" class="form-horizontal form-bordered">
                                    <input type="hidden" class="form-control" name="mid" readonly="readonly" value="${menu.mid}" /> 
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-hf-email">选中父节点</label>
                                            <div class="col-md-9">
                                                <select id="querynode" class="form-control" name="parid">
					                            </select>
                                                <span class="help-block">选择父节点</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-hf-email">名称</label>
                                            <div class="col-md-9">
                                                <input type="text" id="example-hf-email" name="menuname" value="${menu.menuname}"  class="form-control">
                                                <span class="help-block">请输入名称</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-hf-email">链接</label>
                                            <div class="col-md-9">
                                                <input type="text" id="example-hf-email" name="url" value="${menu.url}"  class="form-control">
                                                <span class="help-block">请输入链接</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-hf-email">备注</label>
                                            <div class="col-md-9">
                                                <input type="email" id="example-hf-email" name="remark" value="${menu.remark}"  class="form-control">
