						...
						<ul class="sidebar-nav">
							...
							<li><a href="#" class="sidebar-nav-menu"><i
								...
								<ul>
									...
									<li><a href="<%=basePath%>admin/article/articles">所有文章</a>
									</li>
							...
							<li class="active"><a href="#" class="sidebar-nav-menu"><i
								...
								<ul>
									...
									<li><a class="active" href="<%=basePath%>admin/menu/menus">菜单管理</a>
									</li>
				...
				<div id="page-content">
					...
					<div class="block full">
						...
						<div class="table-responsive">
							<p class="sub-header">
								<a href="<%=basePath%>admin/menu/add" class="btn btn-primary"><span
									class="fa fa-plus"></span>添加</a> | <a id="modify"
									class="btn btn-success"><span
									class="fa fa-pencil"></span>修改</a> | <a id="delete"
									class="btn btn-danger"><span
									class="fa fa-times"></span>删除</a>
								<!--  | <a-->
