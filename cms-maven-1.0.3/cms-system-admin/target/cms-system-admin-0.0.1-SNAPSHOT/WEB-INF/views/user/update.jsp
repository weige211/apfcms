                        ...
                        <div class="row">
                        	 <div class="col-md-12">
                        	 	<div class="block">
                                    ...
                                    <form action="<%=basePath%>admin/user/update" method="post" class="form-horizontal form-bordered" >
                                    <input type="hidden" class="form-control" name="uid" readonly="readonly" value="${user.uid}" />
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="example-hf-email" name="username" value="${user.username}" class="form-control">
                                                <span class="help-block">请输入用户名</span>
                                            </div>
                                        </div>
       
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-hf-email">电话</label>
                                            <div class="col-md-9">
                                                <input type="text" id="example-hf-email" name="phone" value="${user.phone}" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="email" id="example-hf-email" name="email" value="${user.email}"  class="form-control">
                                                <span class="help-block">请输入邮箱</span>
                                            </div>
                                        </div>
                                        
                                         <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-hf-password">角色</label>
                                            <div class="col-md-9">
											...
											<span class="help-block">请选择角色</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="example-hf-email" name="remark" value="${user.remark}" class="form-control">
