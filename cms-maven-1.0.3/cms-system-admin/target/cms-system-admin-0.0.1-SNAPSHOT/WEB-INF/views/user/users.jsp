	...
	<body>
	  ...
	  <!-- Page Wrapper -->
                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li class="active">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a class="active" href="<%=basePath%>admin/user/users">用户管理</a>
                                        </li>
                                        <li>
                        ...
                        <div class="block full">
                            ...
                            <div class="table-responsive">
                                <table id="example-datatable" class="table table-striped table-bordered table-vcenter">      
                                 <a class="btn btn-primary" href="<%=basePath%>admin/user/add"><span class="fa fa-plus"></span>添加</a>                                    <thead>
                                        <tr>
                                            <th class="text-center" style="width: 75px;">用户名</th>
                                            <th>电话</th>
                                            <th>邮箱</th>
                                            <th>创建时间</th>
									        <th>创建人</th>
								...
								<tr>
									...
									<td>
									 <a href="<%=basePath%>admin/user/${item.uid }/update" data-toggle="tooltip" title="修改" class="btn btn-effect-ripple btn-xs btn-success"><i class="fa fa-pencil"></i></a>
									 <a href="<%=basePath%>admin/user/${item.uid }/del" data-toggle="tooltip" title="删除" class="btn btn-effect-ripple btn-xs btn-danger"><i class="fa fa-times"></i></a>
									 <a id="reset" onclick="resetPwd('${item.uid}')" data-toggle="tooltip" title="密码重置" class="btn btn-effect-ripple btn-xs btn-info"><i class="fa fa-repeat"></i></a>
									</td>
								</tr>
								</c:forEach>
                                    </tbody>
        ...
        function resetPwd(uid){
     	   var url="<%=basePath%>admin/user/"+uid+"/resetpwd";
