                        ...
                        <div class="row">
                        	 <div class="col-md-12">
                        	 	<div class="block">
                                    ...
                                    <form action="<%=basePath%>admin/user/add" method="post" class="form-horizontal form-bordered">
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-hf-email">用户名</label>
                                            <div class="col-md-9">
                                                <input type="text" id="example-hf-email" name="username" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="example-hf-email" name="phone" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="email" id="example-hf-email" name="email" class="form-control">
