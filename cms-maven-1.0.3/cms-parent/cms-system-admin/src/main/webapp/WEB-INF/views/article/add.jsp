					...
					<div class="sidebar-content">
						...
						<ul class="sidebar-nav">
							...
							<li class="active"><a href="#" class="sidebar-nav-menu"><i
								...
								<ul>
									<li><a class="active" href="<%=basePath%>admin/article/add">撰写文章</a></li>
									<li><a 
			...
			<div id="main-container">
				...
				<div id="page-content">
					...
					<div class="block full">
						...
						<form id="formid" action="<%=basePath%>admin/article/add" method="post"
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="text" id="example-hf-email" name="title"
										class="form-control"> <span class="help-block">请输入标题</span>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="text" id="example-hf-email" name="summary"
										class="form-control"> <span class="help-block">请输入摘要</span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="email" id="example-hf-email" name="remark"
										class="form-control"> <span class="help-block">请输入备注</span>
								</div>
