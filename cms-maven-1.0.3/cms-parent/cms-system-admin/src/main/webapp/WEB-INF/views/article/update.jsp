		...
		<div id="page-container"
			...
			<div id="sidebar">
				...
				<div id="sidebar-brand" class="themed-background">
					<a href="<%=basePath%>admin" class="sidebar-title"> <i
						class="fa fa-cube"></i> <span class="sidebar-nav-mini-hide">APF<strong>CMS</strong></span>
					</a>
				</div>
				<!-- END Sidebar Brand -->
				...
				<div id="sidebar-scroll">
					...
					<div class="sidebar-content">
						...
						<ul class="sidebar-nav">
							<li><a href="<%=basePath%>admin"><i
									class="gi gi-compass sidebar-nav-icon"></i><span
									class="sidebar-nav-mini-hide">仪表盘</span></a></li>
							...
							<li class="active"><a href="#" class="sidebar-nav-menu"><i
									...
									class="fa fa-file-text-o sidebar-nav-icon"></i><span
									class="sidebar-nav-mini-hide">文章</span></a>
								<ul>
									<li><a href="<%=basePath%>admin/article/add">撰写文章</a></li>
									<li><a class="active"
										href="<%=basePath%>admin/article/articles">所有文章</a></li>
									<li><a href="<%=basePath%>admin/category/categorys">文章类别</a>
									</li>
								</ul></li>
							<li><a href="#" class="sidebar-nav-menu"><i
								...
								<ul>
									<li><a href="<%=basePath%>admin/menu/menus">菜单管理</a></li>
									<li><a href="<%=basePath%>admin/user/users">用户管理</a></li>
									<li><a href="<%=basePath%>admin/role/roles">角色管理</a></li>
									
								</ul></li>
							<li><a href="#" class="sidebar-nav-menu"><i
									class="fa fa-chevron-left sidebar-nav-indicator sidebar-nav-mini-hide"></i><i
									class="gi gi-cardio sidebar-nav-icon"></i><span
									class="sidebar-nav-mini-hide">数据统计</span></a>
								<ul>
									    <li>
					...
					<ul class="nav navbar-nav-custom pull-right">
						...
						<li class="dropdown"><a href="javascript:void(0)"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								src="<%=basePath%>img/placeholders/avatars/avatar9.jpg"
								alt="avatar">
						</a>
							<ul class="dropdown-menu dropdown-menu-right">
								<li class="dropdown-header"><strong><%=username%></strong>
								</li>
								<li><a href="<%=basePath%>admin/article/articles"> <i
										class="fa fa-file-text-o fa-fw pull-right"></i> 所有文章
								</a></li>
								<li class="divider">
								<li>
								<li><a href="<%=basePath%>admin/user/signout"> <i
				...
				<div id="page-content">
					...
					<div class="block full">
						...
						<form id="upload" class="form-horizontal" role="form"
							...
							<label class="col-md-3 control-label" for="example-hf-email">上传图片</label>
								<div class="col-md-9">
									<input class="form-control" id="file" type="file" value="${entity.imgurl }"
								name="file" />
								 <div id="imgDiv">
								 <img class="img-responsive img-thumbnail" src="<%=basePath%>uploads/${entity.imgurl }"/>
								 </div>
								 <span class="help-block">上传图片</span>
								</div>
							</div>
                             <div class="form-group form-actions">
								<div class="col-md-9 col-md-offset-3">
									<button type="button" onclick="upload()" 
										class="btn btn-effect-ripple btn-primary">上传</button>
								</div>
							</div>
						</form>

						<!-- Horizontal Form Content -->
						<form id="formid" action="<%=basePath%>admin/article/update" method="post"
							class="form-horizontal form-bordered">
							<input type="hidden" id="imgurl" name="imgurl" value="${entity.imgurl }" />
							<input type="hidden"  name="aid" value="${entity.aid}" />
							<div class="form-group">
								<label class="col-md-3 control-label" for="example-hf-email">标题</label>
								<div class="col-md-9">
									<input type="text" id="example-hf-email" name="title"
										class="form-control" value="${entity.title}"> <span class="help-block">请输入标题</span>
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 control-label" for="example-hf-email">类别</label>
								<div class="col-md-9">
									<select class="form-control" name="cid">
						       <c:forEach items="${list}" var="item">
						        <c:choose>
						 	<c:when test="${item.cid == entity.cid}">
						 	<option value="${item.cid}" selected="selected">${item.catename}</option>
                           </c:when>
                            <c:otherwise>
                            <option value="${item.cid}" >${item.catename}</option>
					          ...
					          </select> <span class="help-block">请选择类别</span>
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 control-label" for="example-hf-email">摘要</label>
								<div class="col-md-9">
									<input type="text" id="example-hf-email" name="summary"
										class="form-control" value="${entity.summary }"> <span class="help-block">请输入摘要</span>
								</div>
							</div>

							<div class="form-group">
								<label class="col-md-3 control-label" for="example-hf-email">内容</label>
								<div class="col-md-9">
									<input type="hidden" id="content" class="form-control"
										name="content" value="" />
									<!-- 加载编辑器的容器 -->
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="email" id="example-hf-email" name="remark"
										class="form-control" value="${entity.remark}"> <span class="help-block">请输入备注</span>
								</div>
							...
							<div class="form-group form-actions">
								<div class="col-md-9 col-md-offset-3">
									<button type="button" onclick="send()"
										class="btn btn-effect-ripple btn-primary">保存</button>
