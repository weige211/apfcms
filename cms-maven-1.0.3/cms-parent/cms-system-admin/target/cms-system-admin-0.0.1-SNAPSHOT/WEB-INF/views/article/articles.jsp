                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li class="active">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a class="active" href="<%=basePath%>admin/article/articles">所有文章</a>
                                        </li>
                                        <li>
                    ...
                    <div id="page-content">
                        ...
                        <div class="block full">
                            ...
                            <div class="table-responsive">
                                ...
                                <a class="btn btn-primary" href="<%=basePath%>admin/article/add"><span class="fa fa-plus"></span>添加</a>
                                    <thead>
                                        <tr>
								...
								<tr>
									...
									<td>
									 <a href="<%=basePath%>admin/article/${item.aid }/update" data-toggle="tooltip" title="修改" class="btn btn-effect-ripple btn-xs btn-success"><i class="fa fa-pencil"></i></a>
									 <a href="<%=basePath%>admin/article/${item.aid }/del" data-toggle="tooltip" title="删除" class="btn btn-effect-ripple btn-xs btn-danger"><i class="fa fa-times"></i></a>
									</td>
								</tr>
								</c:forEach>
                                    </tbody>
